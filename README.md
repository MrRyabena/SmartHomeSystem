...
- [6. Этап I](#stageI)
  - [6.1 Module](#module)
  - [6.2 Организация соединения](#connection-organization)
    - [6.2.1 Покрытие сети](#network-coverage)
    - [6.2.2 Подключение модулей](#connecting-modules)
    - [6.2.3 TCP/IP](#623-tcpip)
- [7. Этап II](#stageII)
- [8. Этап III](#stageIII)
...
- Этап 1. Создание системы автоматизации процессов.
    ...
    - Разработка и реализация модулей, отвечающих за регулирование устройств и процессов.
    - Объединение модулей в единую систему, обучение взаимодействия друг с другом.
...
- Этап 3. Проектирование алгоритмов саморегулирования системы.
    ...
    - Согласование всех алгоритмов для взаимодействия.
