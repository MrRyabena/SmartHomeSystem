...
void shs::argb::EffectsManagerVirtual::setRandomMatrix(uint8_t min_color, uint8_t max_color, shs::t::shs_time_t dt, shs::t::shs_float_t min_line_length_ratio, shs::t::shs_float_t max_line_length_ratio)
{
